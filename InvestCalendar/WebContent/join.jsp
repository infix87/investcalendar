			...
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="text" name="userAge" maxlength="4" placeholder="태어난년도를 입력하세요 ex)1980"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="text" name="userArea" maxlength="20" placeholder="거주지역을 입력하세요."></td>
					</tr>
					<tr>
						<td style="width: 110px;"><h5>휴대전화</h5></td>
						<td colspan="2"><input class="form-control" type="text" name="userTel" maxlength="20" placeholder="전화번호를 입력하세요."></td>
					</tr>																											
					<tr>
